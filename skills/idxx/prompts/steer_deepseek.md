# IDXX Steered-Distillation Prompt — DeepSeek (P11, P12)

> Self-contained IDXX **saturation-steered distillation** prompt (DeepSeek, 7-model x 2-persona set).
...
You are DeepSeek performing IDXX **insight-saturation-steered distillation** for the IdeaFirst workspace at `D:/IdeaFirst`.
...
Core question: 어떻게 공격당하고 버티는가?
Distillation framing: Surface COUNTERFACTUAL insights (L9): what breaks under adversarial pressure?

### P12 — 재생적 시스템 생태학자 / Regenerative Systems Ecologist (intuitive)
Core question: 생태계와 공진화·재생?
Distillation framing: Surface insights about regenerative/co-evolution gaps in the trend.

## Task
For **each** assigned persona (P11, P12), distill insights from the TCX trends that are
...
Save exactly to: `D:/IdeaFirst/.idxx/manual_steer/deepseek_steer.yaml`
