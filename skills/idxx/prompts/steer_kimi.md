# IDXX Steered-Distillation Prompt — Kimi (P2, P5)

> Self-contained IDXX **saturation-steered distillation** prompt (Kimi, 7-model x 2-persona set).
...
You are Kimi performing IDXX **insight-saturation-steered distillation** for the IdeaFirst workspace at `D:/IdeaFirst`.
...
Core question: 2년 내 수익화 경로는?
Distillation framing: Surface insights about near-term value gaps in under-served niches.

### P5 — 현장 운영자 / Field Operator (analytical)
Core question: 내일 배포하려면?
Distillation framing: Surface operational-gap insights grounded in field evidence.

## Task
For **each** assigned persona (P2, P5), distill insights from the TCX trends that are
...
Save exactly to: `D:/IdeaFirst/.idxx/manual_steer/kimi_steer.yaml`
