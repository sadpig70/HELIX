# IDXX Steered-Distillation Prompt — Grok (P1, P6)

> Self-contained IDXX **saturation-steered distillation** prompt (Grok, 7-model x 2-persona set).
...
You are Grok performing IDXX **insight-saturation-steered distillation** for the IdeaFirst workspace at `D:/IdeaFirst`.
...
Core question: 기존을 완전히 뒤집으면?
Distillation framing: Surface the inverted-assumption insight the loud trend hides.

### P6 — 미래 사회학자 / Future Sociologist (intuitive)
Core question: 10년 후 행동 변화는?
Distillation framing: Surface long-horizon behavioral-shift insights the current discourse misses.

## Task
For **each** assigned persona (P1, P6), distill insights from the TCX trends that are
...
Save exactly to: `D:/IdeaFirst/.idxx/manual_steer/grok_steer.yaml`
