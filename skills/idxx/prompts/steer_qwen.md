# IDXX Steered-Distillation Prompt — Qwen (P13, P14)

> Self-contained IDXX **saturation-steered distillation** prompt (Qwen, 7-model x 2-persona set).
...
You are Qwen performing IDXX **insight-saturation-steered distillation** for the IdeaFirst workspace at `D:/IdeaFirst`.
...
Core question: 과거 사이클 반복, 이번엔 뭐가 다른가?
Distillation framing: Surface insights naming which historical cycle repeats and what is genuinely new now.

### P14 — 메커니즘 디자이너 / Mechanism Designer (creative)
Core question: 어떤 인센티브 메커니즘이 자생하는가?
Distillation framing: Surface insights about missing incentive/market mechanisms (generative).

## Task
For **each** assigned persona (P13, P14), distill insights from the TCX trends that are
...
Save exactly to: `D:/IdeaFirst/.idxx/manual_steer/qwen_steer.yaml`
